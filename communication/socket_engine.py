...
class SocketClient(object):
    ...
    def __re_init__(self):
        ...
        self.close()
        replacement = make_socket_engine(self.host, self.port, *self.socket_parameters)
...
def make_socket_engine(host, port, family=socket.AF_INET, s_type=socket.SOCK_STREAM, proto=0, s_timeout=5):
    """
